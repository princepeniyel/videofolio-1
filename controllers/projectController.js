...
exports.updateProject = async (req, res) => {
  try {
    ...
    if (req.files && req.files.video) {
      // Delete old video
      if (fs.existsSync(path.join(__dirname, '..', 'public', project.videoUrl))) {
        fs.unlinkSync(path.join(__dirname, '..', 'public', project.videoUrl));
      }
    ...
    if (req.files && req.files.thumbnail) {
      ...
      if (fs.existsSync(path.join(__dirname, '..', 'public', project.thumbnailUrl))) {
        fs.unlinkSync(path.join(__dirname, '..', 'public', project.thumbnailUrl));
      }
